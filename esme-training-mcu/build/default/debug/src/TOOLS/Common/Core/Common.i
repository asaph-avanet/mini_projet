# 1 "src/TOOLS/Common/Core/Common.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/TOOLS/Common/Core/Common.c" 2
# 28 "src/TOOLS/Common/Core/Common.c"
...
# 28 "src/TOOLS/Common/Core/Common.c" 2
# 40 "src/TOOLS/Common/Core/Common.c"
#pragma message("[CMN ] Info: DebugMode -> disabled")
# 53 "src/TOOLS/Common/Core/Common.c"
#pragma message("[CMN ] Info: FreeRTOS -> disabled")
# 64 "src/TOOLS/Common/Core/Common.c"
#pragma message("[CMN ] Info: Printf -> enabled")
# 77 "src/TOOLS/Common/Core/Common.c"
#pragma message("[CMN ] Info: ErrorLed -> enabled")
# 95 "src/TOOLS/Common/Core/Common.c"
static _Bool CMN_bSystemStarted = 0;
# 114 "src/TOOLS/Common/Core/Common.c"
void CMN_vidInitialize(void)
{
                         ...
                         char const * const kpkpau8FunctionName)
{
  ...
  _Bool bDontBlock = CMN_bSystemStarted;
  ...
  if(!(kbCondition))
  {
    if(bDontBlock)
    {
      printf("[CMN ] Warning: Assert triggered at \"%s\", line %d (function: \"%s\")\r\n", kpkpau8FileName, ku16FileLine, kpkpau8FunctionName);
    ...
    {
      printf("[CMN ] Error: Assert triggered at \"%s\", line %d (function: \"%s\")\r\n", kpkpau8FileName, ku16FileLine, kpkpau8FunctionName);

      CMN_vidPortDisableIsr();
...
void CMN_vidManageAbort(const uint16_t ku16FileLine,
                        ...
                        char const * const kpkpau8FunctionName)
{
  printf("[CMN ] Error: Abort triggered at \"%s\", line %d (function: \"%s\")\r\n", kpkpau8FileName, ku16FileLine, kpkpau8FunctionName);
