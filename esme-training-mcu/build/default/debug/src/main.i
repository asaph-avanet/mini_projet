...
typedef void (*GPIO_ButtonCallback_t)(void);
...
# 1 "src/APP\\AppManager.h" 1
# 24 "src/APP\\AppManager.h"
void APPM_vidInit(void);
void APPM_vidButtonPressed(void);
...
#pragma config LVP = ON
 ...
 (INTCONbits.GIE = 1);
    ...
    CMN_vidManageAbort((uint16_t)(73), (char const * const)("src/main.c"), (char const * const)(__FUNCTION__));
}
