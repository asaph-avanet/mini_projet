...
# 1 "src/HARDWARE/ISR\\ISR.h" 1
# 71 "src/HARDWARE/ISR\\ISR.h"
...
# 93 "src/HARDWARE/ISR\\ISR.h"
typedef _Bool (*ISR_tpfbCallback)(void);
# 105 "src/HARDWARE/ISR\\ISR.h"
_Bool ISR_bRegisterIsrCbk(const ISR_tenuPeripheral kenuPeripheralId, const ISR_tpfbCallback kpfbCallback);
# 114 "src/HARDWARE/ISR\\ISR.h"
_Bool ISR_bUnregisterIsrCbk(const ISR_tenuPeripheral kenuPeripheralId);
# 35 "src/main.c" 2

# 1 "src/HARDWARE/CLOCK/Core\\CLOCK.h" 1
# 32 "src/HARDWARE/CLOCK/Core\\CLOCK.h"
# 1 "src/HARDWARE/CLOCK/Conf\\CLOCK_cfg.h" 1
# 32 "src/HARDWARE/CLOCK/Core\\CLOCK.h" 2
# 60 "src/HARDWARE/CLOCK/Core\\CLOCK.h"
void CLOCK_vidInitialize(void);
# 36 "src/main.c" 2

# 1 "src/HARDWARE/ADC/Core\\ADC.h" 1
# 31 "src/HARDWARE/ADC/Core\\ADC.h"
# 1 "src/HARDWARE/ADC/Conf\\ADC_cfg.h" 1
# 31 "src/HARDWARE/ADC/Core\\ADC.h" 2
# 48 "src/HARDWARE/ADC/Core\\ADC.h"
typedef enum ADC_tenuStatus
{
  ADC_eSTATUS_OK = 0,
  ADC_eSTATUS_NO_OK,
  ADC_eSTATUS_NULL_POINTER,
  ADC_eSTATUS_CONVERSION_TIMEOUT,
  ADC_eSTATUS_COUNT
}ADC_tenuStatus;
# 65 "src/HARDWARE/ADC/Core\\ADC.h"
...
# 1 "src/HARDWARE/TIMER\\TIMER.h" 1
# 45 "src/HARDWARE/TIMER\\TIMER.h"
...
# 130 "src/HARDWARE/TIMER\\TIMER.h"
void TIM0_vidInitialize(void);
# 140 "src/HARDWARE/TIMER\\TIMER.h"
_Bool TIM0_bRegisterTimerCbk(const TIM0_tpfvidRxCallback kpfCallback);
# 172 "src/HARDWARE/TIMER\\TIMER.h"
_Bool TIM0_bStart(const TIM0_tenuClkSrc kenuClockSrc,
...
_Bool TIM0_bStop(void);
# 38 "src/main.c" 2

# 1 "src/HARDWARE/EUSART\\EUSART.h" 1
# 45 "src/HARDWARE/EUSART\\EUSART.h"
typedef enum EUSART_tenuStatus
{
  EUSART_eSTATUS_OK = 0,
  EUSART_eSTATUS_NO_OK,
  EUSART_eSTATUS_NULL_POINTER,
  EUSART_eSTATUS_TIMEOUT,
  EUSART_eSTATUS_RW_OVERRUN,
  EUSART_eSTATUS_FRAMING_ERROR,
  EUSART_eSTATUS_COUNT
}EUSART_tenuStatus;
# 65 "src/HARDWARE/EUSART\\EUSART.h"
...
# 81 "src/HARDWARE/EUSART\\EUSART.h"
void EUSART_vidInitialize(void);
# 92 "src/HARDWARE/EUSART\\EUSART.h"
...
# 109 "src/HARDWARE/EUSART\\EUSART.h"
...
# 131 "src/main.c"
  ...
  while(1)
  {
    ...
    _delay((unsigned long)((500)*((32 * 1000000UL)/4000.0)));
  ...
  CMN_vidManageAbort((uint16_t)(144), (char const * const)("src/main.c"), (char const * const)(__FUNCTION__));
}
