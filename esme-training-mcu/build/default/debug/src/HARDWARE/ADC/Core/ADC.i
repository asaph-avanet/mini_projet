...
# 2 "<built-in>" 2
# 1 "src/HARDWARE/ADC/Core/ADC.c" 2
# 29 "src/HARDWARE/ADC/Core/ADC.c"
...
# 29 "src/HARDWARE/ADC/Core/ADC.c" 2
...
# 30 "src/HARDWARE/ADC/Core/ADC.c" 2
...
# 31 "src/HARDWARE/ADC/Core/ADC.c" 2
...
# 32 "src/HARDWARE/ADC/Core/ADC.c" 2
...
# 33 "src/HARDWARE/ADC/Core/ADC.c" 2
# 73 "src/HARDWARE/ADC/Core/ADC.c"
void ADC_vidInitialize(void)
{
  CMN_vidManageAssert((_Bool)(0x0F87 != 0), (uint16_t)(75), (char const * const)("src/HARDWARE/ADC/Core/ADC.c"), (char const * const)(__FUNCTION__));
  CMN_vidManageAssert((_Bool)(0x0F0C != 0), (uint16_t)(76), (char const * const)("src/HARDWARE/ADC/Core/ADC.c"), (char const * const)(__FUNCTION__));
  CMN_vidManageAssert((_Bool)(0x0 < 8), (uint16_t)(77), (char const * const)("src/HARDWARE/ADC/Core/ADC.c"), (char const * const)(__FUNCTION__));

  ((*(volatile uint16_t *)0x0F87) |= ((1 << 0x0)));
  ((*(volatile uint16_t *)0x0F0C) |= ((1 << 0x0)));
...
ADC_tenuStatus ADC_enuGetRawValue(uint16_t * const kpu16AdcRawValue, const uint32_t ku32TimeoutMs)
{
  ...
  while((ADCON0 & 0x1) && (u32TimeoutIdx < ku32TimeoutMs))
  {
  ...
  if(u32TimeoutIdx >= ku32TimeoutMs)
  {
    ...
    *kpu16AdcRawValue = (uint16_t)0xffff;
  }
  else
  {
