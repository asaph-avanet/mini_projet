...
# 2 "<built-in>" 2
# 1 "src/HARDWARE/I2CM/I2CM.c" 2
# 29 "src/HARDWARE/I2CM/I2CM.c"
...
# 32 "src/HARDWARE/I2CM/I2CM.c" 2
# 56 "src/HARDWARE/I2CM/I2CM.c"
static _Bool bI2cReservedAddress(const uint8_t ku8I2cAddress);
                                        ...
                                        const uint16_t ku16TxBufferSize)
{
  ...
  else
  {
    ...
    SSP1BUF = (uint8_t)((ku8I2cSlaveAddress << 1) & ~0x01);
                                       ...
                                       const uint16_t ku16RxBufferSize)
{
  ...
  else if((kpku8TxBuffer == ((void*)0)) || (kpu8RxBuffer == ((void*)0)))
  {
    enuStatus = I2CM_eSTATUS_NULL_POINTER;
  }
