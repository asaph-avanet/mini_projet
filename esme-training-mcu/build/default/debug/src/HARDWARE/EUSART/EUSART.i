# 1 "src/HARDWARE/EUSART/EUSART.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 29 "src/TOOLS/Common/Core\\Common.h" 2
...
# 29 "src/HARDWARE/EUSART/EUSART.c" 2
...
# 30 "src/HARDWARE/EUSART/EUSART.c" 2
# 68 "src/HARDWARE/EUSART/EUSART.c"
...
# 103 "src/HARDWARE/EUSART/EUSART.c"
static const uint16_t EUSART_kau16BaudRateCoef[eFOSC_COUNT][eBAUDRATE_COUNT] =
{
  { 832, 207, 103, 25, 23, 12, 0, 0 },
  { 3332, 832, 416, 103, 95, 51, 16, 8 },
  { 6666, 1666, 832, 207, 191, 103, 34, 16 },
  { 26666, 6666, 3332, 832, 767, 416, 138, 68 },
};
...
static EUSART_tpfvidRxCallback EUSART_pfRxCallback = ((void*)0);
# 127 "src/HARDWARE/EUSART/EUSART.c"
static _Bool bInterruptHandler(void);
...
static _Bool bInterruptHandler(void)
{
  ...
  if((PIE3bits.RC2IE == 1) && (PIR3bits.RC2IF == 1))
  {
    ...
    while((PIR3bits.RC2IF == 0) && (u8TimeoutIdx < 10))
    {
      _delay((unsigned long)((1)*((32 * 1000000UL)/4000.0)));
...
void EUSART_vidInitialize(void)
{
  ...
  CMN_vidManageAssert((_Bool)((0 <= eBAUDRATE_115200) && (eBAUDRATE_115200 < eBAUDRATE_COUNT)), (uint16_t)(197), (char const * const)("src/HARDWARE/EUSART/EUSART.c"), (char const * const)(__FUNCTION__));
  ...
  switch(32)
  {
    ...
    case 32:
      ...
      break;
    default:
      CMN_vidManageAbort((uint16_t)(215), (char const * const)("src/HARDWARE/EUSART/EUSART.c"), (char const * const)(__FUNCTION__));
      break;
  }
  ...
  SP2BRGL = ((EUSART_kau16BaudRateCoef[enuCLockId][eBAUDRATE_115200] & 0x00ff));
  SP2BRGH = ((EUSART_kau16BaudRateCoef[enuCLockId][eBAUDRATE_115200] & 0xff00) >> 8);
  TX2STAbits.BRGH = 1;
