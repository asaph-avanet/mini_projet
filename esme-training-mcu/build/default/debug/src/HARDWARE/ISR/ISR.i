...
# 2 "<built-in>" 2
# 1 "src/HARDWARE/ISR/ISR.c" 2
# 29 "src/HARDWARE/ISR/ISR.c"
...
# 29 "src/HARDWARE/ISR/ISR.c" 2
# 51 "src/HARDWARE/ISR/ISR.c"
static ISR_tpfbCallback ISR_apfbCallback[ISR_ePERIPHERAL_END] = { ((void*)0) };
# 63 "src/HARDWARE/ISR/ISR.c"
void __attribute__((picinterrupt(("")))) vidInterruptManager(void);
...
void __attribute__((picinterrupt(("")))) vidInterruptManager(void)
{
  ...
  for(enuPeripheral = 0, bIsIsrFound = 0; ((enuPeripheral < ISR_ePERIPHERAL_END) && (bIsIsrFound == 0)); enuPeripheral++)
  {




    if(ISR_apfbCallback[enuPeripheral] != ((void*)0))
    {
...
_Bool ISR_bRegisterIsrCbk(const ISR_tenuPeripheral kenuPeripheralId, const ISR_tpfbCallback kpfbCallback)
{
  ...
  if((ISR_ePERIPHERAL_BEGIN < kenuPeripheralId) && (kenuPeripheralId < ISR_ePERIPHERAL_END) && (kpfbCallback != ((void*)0)))
  {
...
_Bool ISR_bUnregisterIsrCbk(const ISR_tenuPeripheral kenuPeripheralId)
{
  ...
  {
    ISR_apfbCallback[kenuPeripheralId] = ((void*)0);
    bStatus = 1;
  }
