# 1 "src/HARDWARE/CLOCK/Core/CLOCK.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/HARDWARE/CLOCK/Core/CLOCK.c" 2
# 31 "src/HARDWARE/CLOCK/Core/CLOCK.c"
...
# 31 "src/HARDWARE/CLOCK/Core/CLOCK.c" 2
# 67 "src/HARDWARE/CLOCK/Core/CLOCK.c"
void CLOCK_vidInitialize(void)
{
...
# 90 "src/HARDWARE/CLOCK/Core/CLOCK.c"
 OSCCON1bits.NDIV = 0b0001;
# 99 "src/HARDWARE/CLOCK/Core/CLOCK.c"
}
