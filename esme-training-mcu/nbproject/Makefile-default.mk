...
SOURCEFILES_QUOTED_IF_SPACED=src/main.c src/DRIVERS/LCD/Core/LCD.c src/HARDWARE/ADC/Core/ADC.c src/HARDWARE/CLOCK/Core/CLOCK.c src/HARDWARE/EUSART/EUSART.c src/HARDWARE/I2CM/I2CM.c src/HARDWARE/ISR/ISR.c src/HARDWARE/TIMER/TIMER.c src/TOOLS/Common/Core/Common.c src/TOOLS/Common/Port/Common_pt.c src/DRIVERS/LCD/Conf/LCD_cfg.c src/HARDWARE/GPIO/GPIO.c src/APP/AppManager.c src/DRIVERS/MCP9700/MCP9700.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/DRIVERS/LCD/Core/LCD.p1 ${OBJECTDIR}/src/HARDWARE/ADC/Core/ADC.p1 ${OBJECTDIR}/src/HARDWARE/CLOCK/Core/CLOCK.p1 ${OBJECTDIR}/src/HARDWARE/EUSART/EUSART.p1 ${OBJECTDIR}/src/HARDWARE/I2CM/I2CM.p1 ${OBJECTDIR}/src/HARDWARE/ISR/ISR.p1 ${OBJECTDIR}/src/HARDWARE/TIMER/TIMER.p1 ${OBJECTDIR}/src/TOOLS/Common/Core/Common.p1 ${OBJECTDIR}/src/TOOLS/Common/Port/Common_pt.p1 ${OBJECTDIR}/src/DRIVERS/LCD/Conf/LCD_cfg.p1 ${OBJECTDIR}/src/HARDWARE/GPIO/GPIO.p1 ${OBJECTDIR}/src/APP/AppManager.p1 ${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/DRIVERS/LCD/Core/LCD.p1.d ${OBJECTDIR}/src/HARDWARE/ADC/Core/ADC.p1.d ${OBJECTDIR}/src/HARDWARE/CLOCK/Core/CLOCK.p1.d ${OBJECTDIR}/src/HARDWARE/EUSART/EUSART.p1.d ${OBJECTDIR}/src/HARDWARE/I2CM/I2CM.p1.d ${OBJECTDIR}/src/HARDWARE/ISR/ISR.p1.d ${OBJECTDIR}/src/HARDWARE/TIMER/TIMER.p1.d ${OBJECTDIR}/src/TOOLS/Common/Core/Common.p1.d ${OBJECTDIR}/src/TOOLS/Common/Port/Common_pt.p1.d ${OBJECTDIR}/src/DRIVERS/LCD/Conf/LCD_cfg.p1.d ${OBJECTDIR}/src/HARDWARE/GPIO/GPIO.p1.d ${OBJECTDIR}/src/APP/AppManager.p1.d ${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/DRIVERS/LCD/Core/LCD.p1 ${OBJECTDIR}/src/HARDWARE/ADC/Core/ADC.p1 ${OBJECTDIR}/src/HARDWARE/CLOCK/Core/CLOCK.p1 ${OBJECTDIR}/src/HARDWARE/EUSART/EUSART.p1 ${OBJECTDIR}/src/HARDWARE/I2CM/I2CM.p1 ${OBJECTDIR}/src/HARDWARE/ISR/ISR.p1 ${OBJECTDIR}/src/HARDWARE/TIMER/TIMER.p1 ${OBJECTDIR}/src/TOOLS/Common/Core/Common.p1 ${OBJECTDIR}/src/TOOLS/Common/Port/Common_pt.p1 ${OBJECTDIR}/src/DRIVERS/LCD/Conf/LCD_cfg.p1 ${OBJECTDIR}/src/HARDWARE/GPIO/GPIO.p1 ${OBJECTDIR}/src/APP/AppManager.p1 ${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.p1
...
${OBJECTDIR}/src/main.p1: src/main.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -Og -maddrqual=ignore -xassembler-with-cpp -I"src/DRIVERS/LCD/Conf" -I"src/DRIVERS/LCD/Core" -I"src/HARDWARE/ADC/Conf" -I"src/HARDWARE/ADC/Core" -I"src/HARDWARE/CLOCK/Conf" -I"src/HARDWARE/CLOCK/Core" -I"src/HARDWARE/EUSART" -I"src/HARDWARE/I2CM" -I"src/HARDWARE/ISR" -I"src/HARDWARE/TIMER" -I"src/TOOLS/Common/Conf" -I"src/TOOLS/Common/Core" -I"src/TOOLS/Common/Port" -I"src/HARDWARE/GPIO" -I"APP" -I"src/APP" -I"src/HARDWARE/GPIO" -I"src/DRIVERS/MCP9700" -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/src/main.p1 src/main.c 
...
${OBJECTDIR}/src/APP/AppManager.p1: src/APP/AppManager.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/src/APP" 
	@${RM} ${OBJECTDIR}/src/APP/AppManager.p1.d 
	@${RM} ${OBJECTDIR}/src/APP/AppManager.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -Og -maddrqual=ignore -xassembler-with-cpp -I"src/DRIVERS/LCD/Conf" -I"src/DRIVERS/LCD/Core" -I"src/HARDWARE/ADC/Conf" -I"src/HARDWARE/ADC/Core" -I"src/HARDWARE/CLOCK/Conf" -I"src/HARDWARE/CLOCK/Core" -I"src/HARDWARE/EUSART" -I"src/HARDWARE/I2CM" -I"src/HARDWARE/ISR" -I"src/HARDWARE/TIMER" -I"src/TOOLS/Common/Conf" -I"src/TOOLS/Common/Core" -I"src/TOOLS/Common/Port" -I"src/HARDWARE/GPIO" -I"APP" -I"src/APP" -I"src/HARDWARE/GPIO" -I"src/DRIVERS/MCP9700" -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/src/APP/AppManager.p1 src/APP/AppManager.c 
	@-${MV} ${OBJECTDIR}/src/APP/AppManager.d ${OBJECTDIR}/src/APP/AppManager.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/src/APP/AppManager.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.p1: src/DRIVERS/MCP9700/MCP9700.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/src/DRIVERS/MCP9700" 
	@${RM} ${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.p1.d 
	@${RM} ${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -Og -maddrqual=ignore -xassembler-with-cpp -I"src/DRIVERS/LCD/Conf" -I"src/DRIVERS/LCD/Core" -I"src/HARDWARE/ADC/Conf" -I"src/HARDWARE/ADC/Core" -I"src/HARDWARE/CLOCK/Conf" -I"src/HARDWARE/CLOCK/Core" -I"src/HARDWARE/EUSART" -I"src/HARDWARE/I2CM" -I"src/HARDWARE/ISR" -I"src/HARDWARE/TIMER" -I"src/TOOLS/Common/Conf" -I"src/TOOLS/Common/Core" -I"src/TOOLS/Common/Port" -I"src/HARDWARE/GPIO" -I"APP" -I"src/APP" -I"src/HARDWARE/GPIO" -I"src/DRIVERS/MCP9700" -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.p1 src/DRIVERS/MCP9700/MCP9700.c 
	@-${MV} ${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.d ${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/src/DRIVERS/MCP9700/MCP9700.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${DISTDIR}/esme-training-mcu.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/esme-training-mcu.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -Og -maddrqual=ignore -xassembler-with-cpp -I"src/DRIVERS/LCD/Conf" -I"src/DRIVERS/LCD/Core" -I"src/HARDWARE/ADC/Conf" -I"src/HARDWARE/ADC/Core" -I"src/HARDWARE/CLOCK/Conf" -I"src/HARDWARE/CLOCK/Core" -I"src/HARDWARE/EUSART" -I"src/HARDWARE/I2CM" -I"src/HARDWARE/ISR" -I"src/HARDWARE/TIMER" -I"src/TOOLS/Common/Conf" -I"src/TOOLS/Common/Core" -I"src/TOOLS/Common/Port" -I"src/HARDWARE/GPIO" -I"APP" -I"src/APP" -I"src/HARDWARE/GPIO" -I"src/DRIVERS/MCP9700" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/esme-training-mcu.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
